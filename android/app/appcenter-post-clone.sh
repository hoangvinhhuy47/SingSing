...
#git clone -b '2.10.5' https://github.com/flutter/flutter.git
...
if [ "$APPCENTER_BRANCH" == "development" ]; then
  ...
  mkdir -p android/app/build/outputs/apk/; mv build/app/outputs/apk/development/release/app-development-release.apk $_
  mkdir -p android/app/build/outputs/bundle/; mv build/app/outputs/bundle/developmentRelease/app-development-release.aab $_

  fi

if [ "$APPCENTER_BRANCH" == "s2e-development" ]; then
