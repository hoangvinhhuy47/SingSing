...
class _IntroScreenState extends State<IntroScreen> {
  ...
  Widget _indicator(bool isActive) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        gradient: isActive? const LinearGradient(colors: [Color(0xFFBF26E5), Color(0xFF3C14DA)]) : null,
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          if (index == data.length - 1) _buildStartButton() else Container(height: 48)
        ],
      ),
    );
  }
