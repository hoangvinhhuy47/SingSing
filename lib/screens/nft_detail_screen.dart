...
class _NftDetailScreenState extends State<NftDetailScreen> {
        ...
        children: [
          Stack(
            ...
            children: [
              ...
              if (_nft.externalData?.media != null)
                Container(
  ...
  String _category() {
    int? index = _nft.externalData?.attributes
        ?.indexWhere((element) => element.traitType == 'category');
    if (index != null && index > 0) {
      return _nft.externalData?.attributes![index].value;
    }
    return '';
  }
}
