extension StringExtension on String {
  ...
  String getFirstUrl() {
    ...
    final start = _urlRegExp.firstMatch(this)?.start;
    final end = _urlRegExp.firstMatch(this)?.end;
    String result = '';
  ...
  static bool validateWalletAddress(String address) {
    var regex = RegExp(r'^0x?[0-9a-fA-F].{39}$');
